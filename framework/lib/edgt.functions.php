...
if(!function_exists('goodwish_edge_addslashes')) {
    /**
     ...
     */
    function goodwish_edge_addslashes($str) {
...
if(!function_exists('goodwish_edge_core_plugin_message')) {
    /**
     * Function that prints a mesasge in the admin if user hides TGMPA plugin activation message
     */
    function goodwish_edge_core_plugin_message() {
        if(get_user_meta(get_current_user_id(), 'tgmpa_dismissed_notice', true) && !goodwish_edge_core_installed()) {
            echo apply_filters('goodwish_edge_core_plugin_message', '<div class="update-nag">'.esc_html__('Installation of the "Edge
            Core" plugin is
            essential for
            proper
            theme functioning. Please ', 'goodwish').'<a href="'.esc_url(admin_url('themes.php?page=install-required-plugins'))
                .'">'.esc_html__('install', 'goodwish').'</a>'.esc_html__(' this
            plugin and activate it', 'goodwish').'</div>');
        }
    }

    add_action('admin_notices', 'goodwish_edge_core_plugin_message');
}
...
if (!function_exists('goodwish_edge_paged_home')) {
    /**
     * Set false to on paged url on homepage
     *
     * @return int
     */
    function goodwish_edge_paged_home()
    {
        global $wp_query;
    ...
    add_filter('redirect_canonical', 'goodwish_edge_paged_home');
}
